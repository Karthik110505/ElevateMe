...
const SignupPage = () => {
  ...
  const getUserTypeFromPath = () => {
    if (paramUserType) return paramUserType;
  ...
  const handleOAuthSignup = (provider) => {
    // Store user type in localStorage to retrieve after OAuth callback
    ...
    window.location.href = `${baseUrl}/api/auth/${provider}?userType=${userType}`;
  };
          ...
          <div className="flex flex-col max-w-[480px] w-full">
            <div className="text-center mb-8">
              <h1 className="text-white text-3xl font-bold leading-tight tracking-[-0.015em] mb-2 font-heading animate-glow">
                Join as {userType === "developer" ? "Developer" : "Employer"}
              </h1>
              <p className="text-gray-300 text-base font-normal leading-normal">
                {userType === "developer"
                  ? "Showcase your projects and connect with employers"
                  : "Discover talented developers and hire the best"}
              </p>
            </div>
            ...
            <div className="bg-dark-800 rounded-xl p-6 border border-neon-blue/20 shadow-neon">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  Create {userType === "developer" ? "Developer" : "Employer"}{" "}
                  Account
                </button>
              </form>
